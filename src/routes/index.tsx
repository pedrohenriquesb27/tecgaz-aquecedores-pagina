...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "TecGaz Aquecedores | Venda, Instalação & Conserto em Guarulhos" },
      {
        name: "description",
        content:
          "Venda, instalação certificada ABNT NBR 13103, manutenção preventiva, conserto e conversão de aquecedores a gás em Guarulhos e região. Atendimento prioritário e laudo técnico.",
      },
      {
        property: "og:title",
        content: "TecGaz Aquecedores | Venda, Instalação & Assistência em Guarulhos",
      },
      {
        property: "og:description",
        content:
          "Venda, instalação, manutenção preventiva e conserto de aquecedores a gás em Guarulhos. Peças originais Rinnai, Rheem, Lorenzetti e Komeco.",
      },
      {
        property: "og:image",
      ...
      {
        name: "twitter:title",
        content: "TecGaz Aquecedores | Venda & Assistência em Guarulhos",
      },
      {
        name: "twitter:description",
        content:
          "Instalação, manutenção preventiva e conserto de aquecedores a gás em Guarulhos. Atendimento técnico certificado.",
      },
      {
        name: "twitter:image",
        content: "/images/hero-chuveiro.jpg",
...
const whyItems = [
  ...
  },
  {
    ...
    description:
      "Medição precisa de exaustão e verificação de vazamentos de gás para condomínios, residências e empresas em Guarulhos.",
  },
];
...
const projects = [
  {
    ...
    text: "Manutenção preventiva programada de aquecedores centrais e redes de gás em condomínios de Guarulhos.",
  },
  {
...
const stats = [
  { value: "+15 Anos", label: "Experiência em Guarulhos" },
  ...
  return (
    <div className="min-h-screen bg-background font-sans text-foreground">
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-2 gap-x-3 gap-y-2 sm:flex sm:items-center sm:justify-between">
          ...
          <div className="contents sm:flex sm:items-center sm:gap-5">
            ...
            <span className="min-w-0 truncate text-right">
              ...
              Av. Dr. Timóteo Penteado, 1791 - Guarulhos
            </span>
          </div>
        </div>
      </div>
        ...
        <div className="relative z-10 mx-auto grid min-h-[calc(100svh-112px)] max-w-7xl items-center gap-10 px-4 py-12 sm:px-[5%] sm:py-16 lg:grid-cols-[minmax(0,1.05fr)_minmax(380px,.95fr)] lg:gap-6">
          <div className="max-w-3xl text-center lg:text-left">
            <span className="inline-flex items-center gap-2 rounded-full border border-primary/40 bg-primary/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-wide text-primary shadow-sm">
              ...
              Assistência Técnica Certificada ABNT em Guarulhos
            </span>
            <h1 className="mt-6 text-4xl font-extrabold leading-[1.08] sm:text-5xl lg:text-6xl">
              Venda, Instalação & Conserto de <span className="text-primary">Aquecedores a Gás</span> em Guarulhos
            </h1>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center md:mb-16">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-base leading-relaxed text-muted-foreground">
              Deslize para conhecer os serviços de venda, instalação, manutenção preventiva e suporte de emergência em Guarulhos.
            </p>
          </div>
            ...
            <div className="relative z-10 flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-2xl">
                <div className="inline-flex items-center gap-2 rounded-full bg-primary-foreground/15 px-4 py-1.5 text-xs font-semibold uppercase backdrop-blur-sm">
                  ...
                  Atendimento Especializado em Guarulhos & Região
                </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-12 text-center md:mb-16">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base text-muted-foreground">
              Confira os depoimentos de clientes que confiaram no nosso trabalho em Guarulhos.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 items-stretch gap-5 lg:grid-cols-12 lg:gap-6">
            <div className="review-score flex flex-col items-center justify-center rounded-2xl border border-border bg-card/70 p-8 text-center backdrop-blur-md lg:col-span-5 lg:p-12">
              ...
              <p className="mt-5 text-base text-muted-foreground">
                ...
                <span className="font-semibold text-foreground">Guarulhos</span>
              </p>
            </div>
                      ...
                      <div className="review-card flex h-full min-h-[320px] flex-col rounded-2xl border border-border bg-card/80 p-7 shadow-sm backdrop-blur-sm sm:p-8 lg:p-10">
                        ...
                        <figcaption className="mt-8 flex items-center gap-4 border-t border-border pt-6">
                          ...
                          <div>
                            ...
                            <span className="text-xs text-muted-foreground">Cliente verificado em Guarulhos</span>
                          </div>
                        </figcaption>
                      </div>
                    </figure>
      ...
      <section className="border-t border-border bg-tecgaz-dark-900 px-4 py-20 text-center sm:px-[5%] md:py-28">
        <h2 className="text-3xl font-bold md:text-4xl">Por que escolher a TecGaz em Guarulhos?</h2>
        <p className="mx-auto mt-4 max-w-2xl text-base text-muted-foreground">
      ...
      <section id="projetos" className="section-texture px-4 py-20 sm:px-[5%] md:py-28">
        <div className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-base text-muted-foreground">
            Atendimento residencial, condominial e comercial em toda a região de Guarulhos e Grande São Paulo.
          </p>
        </div>
      ...
      <section id="quem-somos" className="border-y border-border bg-tecgaz-dark-900 px-4 py-20 sm:px-[5%] md:py-28">
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div>
            <span className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-wide text-primary">
              Tradição & Qualidade em Guarulhos
            </span>
            <h2 className="mt-5 text-3xl font-bold md:text-4xl">Quem Somos</h2>
            <p className="mt-4 text-base leading-relaxed text-muted-foreground">
              A TecGaz Aquecedores é uma empresa de Guarulhos especializada em sistemas de aquecimento de água a gás. Atuamos com venda, instalação, manutenção preventiva, conserto e conversão de gás, sempre em conformidade rigorosa com as normas técnicas da ABNT NBR 13103.
            </p>
          ...
          <img
            ...
            alt="Técnico da TecGaz realizando manutenção de aquecedor a gás em Guarulhos"
            loading="lazy"
            width={1024}
            height={768}
      ...
      <section className="section-texture px-4 py-20 sm:px-[5%] md:py-28">
        <div className="text-center">
          <h2 className="text-3xl font-bold md:text-4xl">Como Chegar na TecGaz</h2>
          <p className="mx-auto mt-3 max-w-2xl text-base text-muted-foreground">
            Estamos localizados na Vila Hulda, em Guarulhos. Venha nos visitar ou solicite uma visita técnica no seu endereço.
          </p>
        </div>
        ...
        <div className="mx-auto mt-12 grid max-w-7xl grid-cols-1 gap-6 lg:grid-cols-3">
          <div className="rounded-2xl border border-border bg-card/80 p-7 backdrop-blur-sm shadow-xl">
            <h3 className="text-xl font-bold">Nossa Sede em Guarulhos</h3>
            ...
            <a
              href="https://www.google.com/maps/dir/?api=1&destination=Av.+Dr.+Tim%C3%B3teo+Penteado%2C+1791+-+Vila+Hulda%2C+Guarulhos+-+SP"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <div className="overflow-hidden rounded-2xl border border-border shadow-2xl lg:col-span-2">
            <iframe
              title="Mapa da localização da TecGaz Aquecedores em Guarulhos"
              src="https://maps.google.com/maps?q=Av.%20Dr.%20Tim%C3%B3teo%20Penteado%2C%201791%20-%20Vila%20Hulda%2C%20Guarulhos%20-%20SP&t=&z=16&ie=UTF8&iwloc=&output=embed"
      ...
      <section className="cta-texture border-y border-primary/70 bg-primary px-4 py-16 text-center text-primary-foreground sm:px-[5%]">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-base opacity-95">
          Fale diretamente com nossa equipe via WhatsApp e receba atendimento rápido em Guarulhos e região.
        </p>
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          ...
          >
            ...
            Chamar no WhatsApp (11) 94030-0560
          </a>
          <a
            href="tel:+551143787585"
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-4 flex flex-col gap-2.5">
              <li>
                ...
                Av. Dr. Timóteo Penteado, 1791 - Vila Hulda - Guarulhos - SP
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 flex flex-col gap-2.5">
              ...
              <li className="mt-2 text-xs">© {new Date().getFullYear()} TecGaz Aquecedores. Todos os direitos reservados.</li>
            </ul>
          </div>
        </div>
      </footer>
